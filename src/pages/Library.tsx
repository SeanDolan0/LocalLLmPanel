      ...
      {loading ? (
        ...
        <Card>
          ...
          <div className="text-sm text-slate-500">
            Use <a className="text-indigo-300 hover:underline" href="#/search">Search</a> to find models and pull them.
          </div>
        </Card>
      ) : (
        <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-3">
          {entries.map((e) => {
            ...
            return (
              <Card key={e.model_id} className="hover:border-indigo-500/40 transition-colors">
                <div className="flex items-start justify-between gap-2">
                  <div className="min-w-0">
                    <div className="truncate font-medium text-slate-200">{e.model_id}</div>
